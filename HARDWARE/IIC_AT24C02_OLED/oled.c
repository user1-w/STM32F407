...
void WriteOLedCmd(uint8_t cmd)
{
	...
	IIC_SendByte(0x78); 	//发送从设备地址
	IIC_Get_Ack();
	
	IIC_SendByte(CtrWord); //发送命令控制字
	IIC_Get_Ack();
...
uint8_t dian[]={0x00,0x00,0xF8,0x88,0x88,0x88,0x88,0xFF,0x88,0x88,0x88,0x88,0xF8,
0x00,0x00,0x00,0x00,0x00,0x1F,0x08,0x08,0x08,0x08,0x7F,0x88,0x88,0x88,0x88,0x9F,0x80,0xF0,0x00};/*"电",0*/
uint8_t ping[]={0x00,0x02,0x02,0x12,0x62,0x02,0x02,0xFE,0x02,0x02,0x42,0x32,0x02,
0x02,0x00,0x00,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xFF,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x00};/*"平",1*/
//6.显示字母函数
...
//		//第1行显示重量
//		OLed_ShowChina(16,0,HZ12);
//		OLed_ShowChina(32,0,HZ13);
//		OLed_Fill(0x00);//描点清屏函数；
//		while(1);
//		return 0 ;
//}
